...
;
CREATE OR REPLACE FUNCTION public.tattoo_cache_update_search_vector()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
$function$
;
CREATE OR REPLACE FUNCTION public.tattoo_cache_update_timestamp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
$function$
;
CREATE OR REPLACE FUNCTION public.tattoo_design_update_search_vector()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
$function$
;
CREATE OR REPLACE FUNCTION public.tattoo_design_update_timestamp()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
