...
import { DomainBadRule, DomainConflict } from '../../../global/domain/exceptions/domain.exception';
...
export class DeleteUserUseCase extends BaseUseCase implements UseCase {
    ...
    public async execute(
        ...
        const [{ user }] = await this.usersProvider.source.query(userQueries.findByIdWithPassword, [userId]);
