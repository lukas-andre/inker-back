...
@Injectable()
export class ValidateEmailAccountVerificationCodeUseCase
  extends BaseUseCase
  implements UseCase
{
  ...
  constructor(
    ...
    super(ValidateEmailAccountVerificationCodeUseCase.name);
  }
  ...
  public async execute(
    ...
    const activateUserResult = await this.usersRepository.activate(userId);
