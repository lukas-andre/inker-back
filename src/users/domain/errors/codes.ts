...
export const ARTIST_ALREADY_EXISTS = 'Artist already exists';
export const ROLE_DOES_NOT_EXIST = 'Role does not exists';
export const PROBLEMS_SAVING_ARTIST = 'Problems saving artist';
...
export const PROBLEMS_CREATING_VERIFICATION_HASH =
  'Problem creating verification hash';
export const USER_NOT_ACCEPTED = 'User not accepted';
export const USER_ID_IS_NOT_VALID = 'User id is not valid';
