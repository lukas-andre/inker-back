...
import { QuotationCreatedJob } from '../quotationCreated.job';

describe('QuotationCreatedJob', () => {
  let job: QuotationCreatedJob;
  ...
  it('should send an email with the correct data when a quotation is created', async () => {
