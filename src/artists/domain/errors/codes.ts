...
// Pipe errors
export const ARTIST_ID_PIPE_FAILED = 'Artist id pipe failed';
export const ARTIST_INVALID_ID_TYPE = 'Artist invalid id type';
export const ARTIST_NOT_ACCEPTED = 'Artist not accepted';
