...
export class StencilRepository extends BaseComponent {
  constructor(
    ...
    super(StencilRepository.name);
  }

  async findStencilsByArtistId(artistId: string): Promise<Stencil[]> {
  ...
  async findAvailableStencilsByArtistId(artistId: string): Promise<Stencil[]> {
    return this.stencilRepository.find({
  ...
  async findStencilById(id: string): Promise<Stencil> {
  ...
  async deleteStencil(id: string): Promise<void> {
  ...
  async countStencilsByArtistId(artistId: string): Promise<number> {
