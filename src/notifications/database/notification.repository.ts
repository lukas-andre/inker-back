...
export class NotificationRepository {
    ...
    async updateFcmToken(criteria: string | string[] | number | number[] | Date | Date[] | ObjectId | ObjectId[] | FindOptionsWhere<UserFcmToken>, partialEntity: QueryDeepPartialEntity<UserFcmToken>) {
