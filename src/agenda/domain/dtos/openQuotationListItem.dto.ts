...
export class OpenQuotationListItemDto {
  ...
  @ApiPropertyOptional({
    description:
      'Estimated distance from artists primary location to customer location in KM',
  })
  ...
  @ApiPropertyOptional({
    type: [OpenQuotationOfferDto],
    description: 'Offers submitted by artists for this quotation',
  })
