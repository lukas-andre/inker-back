...
@Injectable()
export class SubmitQuotationOfferUseCase extends BaseUseCase implements UseCase, OnModuleDestroy {
    constructor(
    ...
    async execute(
        ...
        if (quotation.type !== QuotationType.OPEN || quotation.status !== QuotationStatus.OPEN) {
