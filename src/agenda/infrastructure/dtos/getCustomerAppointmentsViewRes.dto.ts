...
class GroupedAppointmentsDto {
  @ApiProperty({
    ...
    description: 'Events requiring user action',
  })
  ...
  @ApiProperty({
    type: [CustomerAppointmentDto],
    description: 'Upcoming events beyond this week',
  })
  upcoming: CustomerAppointmentDto[];

  @ApiProperty({
    type: [CustomerAppointmentDto],
    description: 'Past events (completed, canceled, etc.)',
  })
...
export class GetCustomerAppointmentsViewResDto {
  @ApiProperty({
    ...
    nullable: true,
    description:
      'The ID of the most important upcoming event or action required',
  })
  heroAppointmentId: string | null;

  @ApiProperty({
    type: GroupedAppointmentsDto,
    description: 'Events grouped by time and status',
  })
