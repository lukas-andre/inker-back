...
@Injectable()
export class AgendaInvitationRepository extends BaseComponent {
  constructor(
    ...
    super(AgendaInvitationRepository.name);
  }
  ...
  async updateStatus(eventId: string, status: AgendaInvitationStatusEnum) {
