...
const loginType_enum_1 = require("../../../auth/domain/enums/loginType.enum");
...
let UsersService = class UsersService {
    ...
    async create(createUserParams, role) {
        ...
        const newUser = Object.assign(new user_entity_1.User(), Object.assign(Object.assign({}, createUserParams), { password: await this.hashPasword(createUserParams.password), role }));
