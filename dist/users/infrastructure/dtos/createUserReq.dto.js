...
class CreateUserReqDto {
    static _OPENAPI_METADATA_FACTORY() {
        return { username: { required: true, type: () => String }, firstName: { required: true, type: () => String }, lastName: { required: true, type: () => String }, email: { required: true, type: () => String }, password: { required: true, type: () => String }, userType: { required: true, enum: require("../../domain/enums/userType.enum").UserType }, phoneNumber: { required: false, type: () => String } };
    }
}
__decorate([
...
__decorate([
    ...
    class_validator_1.IsOptional(),
    __metadata("design:type", String)
], CreateUserReqDto.prototype, "firstName", void 0);
__decorate([
    swagger_1.ApiProperty({
        example: 'Henry',
    ...
    class_validator_1.IsOptional(),
    __metadata("design:type", String)
], CreateUserReqDto.prototype, "lastName", void 0);
__decorate([
    swagger_1.ApiProperty({
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateUserReqDto.prototype, "userType", void 0);
__decorate([
    swagger_1.ApiProperty({
        example: '+56964484712',
    ...
    class_validator_1.IsOptional(),
    __metadata("design:type", String)
], CreateUserReqDto.prototype, "phoneNumber", void 0);
exports.CreateUserReqDto = CreateUserReqDto;
//# sourceMappingURL=createUserReq.dto.js.map