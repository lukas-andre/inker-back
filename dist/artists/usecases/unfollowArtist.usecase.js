...
exports.UnfollowArtistUseCase = void 0;
...
let UnfollowArtistUseCase = class UnfollowArtistUseCase {
    ...
    async execute(id, userId) {
        ...
        if (!existsFollower) {
            result = new domainConflict_exception_1.DomainConflictException('Follower not exist');
        }
        await queryRunner.startTransaction();
        try {
            await queryRunner.manager.getRepository(follower_entity_1.Follower).delete({ userId });
...
UnfollowArtistUseCase = __decorate([
    common_1.Injectable(),
    __metadata("design:paramtypes", [followers_service_1.FollowersService])
], UnfollowArtistUseCase);
exports.UnfollowArtistUseCase = UnfollowArtistUseCase;
//# sourceMappingURL=unfollowArtist.usecase.js.map