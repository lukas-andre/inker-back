...
const domainNotFound_exception_copy_1 = require("../../domain/exceptions/domainNotFound.exception copy");
...
exports.resolveDomainException = (domainException) => {
    ...
    if (domainException instanceof domainNotFound_exception_copy_1.DomainNotFoundException)
